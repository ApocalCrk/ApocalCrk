...
$(function(){
	var link = $("nav .container-fluid .collapse .navbar-nav a");
	...
	$("#experience").click(function(){
		$(".page").hide();
		$(".page").css("top", "30%");
		$("#experience-page").fadeIn("fast");
		$("#experience-page").css("top", "0");
		$(".navbar").css("background", "#242526");
	...
	$("#contact").click(function(){
		$(".page").hide();
		$(".page").css("top", "30%");
		$("#contact-page").fadeIn("fast");
		$("#contact-page").css("top", "0");
		$(".navbar").css("background", "#242526");
		$(".navbar-img").css("width", "50");
		$(".navbar").css("padding", "0");
		$("body").css("overflow-y", "visible");
